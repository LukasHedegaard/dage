...
DESCRIPTION="d-SNE for USPS to MNIST domain adaptation. Train on MNIST, test on USPS. Using hyperparameters found in ~/notebooks/hypersearch-results.ipybn"

METHOD=dsne
EXPERIMENT_ID=dsne_digits_usps_mnist
