...
DESCRIPTION="DAGE for MNIST to MNIST-M domain adaptation. Using hyperparameters found in ~/notebooks/hypersearch-results.ipybn"

METHOD=dage
EXPERIMENT_ID=dage_digits_mnist_mnistm
