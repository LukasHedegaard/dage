...
DESCRIPTION="d-SNE for SVHN to MNIST domain adaptation. Using hyperparameters found in ~/notebooks/hypersearch-results.ipybn"

METHOD=dsne
EXPERIMENT_ID=dsne_digits_svhn_mnist
