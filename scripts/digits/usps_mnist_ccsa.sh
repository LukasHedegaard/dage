...
DESCRIPTION="CCSA for USPS to MNIST domain adaptation. Using hyperparameters found in ~/notebooks/hypersearch-results.ipybn"

METHOD=ccsa
EXPERIMENT_ID=ccsa_digits_usps_mnist
