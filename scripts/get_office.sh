...
# decaf features
./scripts/gdrivedl.sh "https://drive.google.com/uc?export=download&confirm=3X1c&amp&id=0B4IapRTv9pJ1eloxMmVNQ2IzS00" tmp.tar.gz  
tar -xvzf tmp.tar.gz -C datasets/Office31
rm tmp.tar.gz
...
# surf features
./scripts/gdrivedl.sh "https://drive.google.com/uc?id=0B4IapRTv9pJ1aWxLY0kxN0JJeXM&export=download" tmp.tar.gz  
tar -xvzf tmp.tar.gz -C datasets/Office31
rm tmp.tar.gz
