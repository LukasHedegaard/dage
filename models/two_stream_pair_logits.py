...
def model(
    ...
    model_top = model_logits(input_shape=get_output_shape(model_mid), dense_size=output_shape)
    ...
    mid1 = model_top(model_mid(model_base(in1)))
    mid2 = model_top(model_mid(model_base(in2)))
    aux_out = Pair(name='aux_out', embed_size=output_shape)([mid1, mid2])
